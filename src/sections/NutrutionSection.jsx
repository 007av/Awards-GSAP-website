...
const NutrutionSection = () => {
  ...
  return (
    <section className="nutrition-section">
      ...
      <img src="public/images/big-img.png" alt="big-img" className="big-img" />
            ...
            {lists.map((nutrient, index) => (
              <div key={index} className=" relative flex-1 col-center">
                <div>
                  ...
                  <p className=" text-sm font-paragraph">up to</p>
...
export default NutrutionSection;
